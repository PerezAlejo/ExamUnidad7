...
class QuizApp(QWidget):
    ...
    def comenzar_examen(self):
        self.preguntas = preguntas.copy()  # <-- agregado
        random.shuffle(self.preguntas)     # <-- agregado
    ...
    def mostrar_pregunta(self):
        ...
        pregunta = self.preguntas[self.pregunta_actual]  # <-- modificado
    ...
    def validar_respuesta(self):
        ...
        if self.pregunta_actual < len(self.preguntas):  # <-- modificado
            self.mostrar_pregunta()
        else:
    ...
    def terminar_examen(self):
        self.timer.stop()
        calificacion = (self.puntaje / len(self.preguntas)) * 10  # <-- modificado
